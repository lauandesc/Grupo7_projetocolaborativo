...
SELECT usuario.nome_completo, doacao_livro.tipo_doacao, doacao_livro.conservacao, doacao_livro.titulo, doacao_livro.autor, doacao_livro.editora, doacao_livro.quantidade, doacao_livro.img_conservacao
FROM usuario 
